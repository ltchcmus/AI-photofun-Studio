        ...
        if (accessToken) {
          ...
          try {
            ...
            const checkResponse = await axiosClient.get(
              "/api/v1/identity/users/check-login-by-google"
            );
            console.log(
              "✅ Check login by Google response:",
              checkResponse.data
            );
            console.log("   - Code:", checkResponse.data.code);
            console.log(
              "   - Result (isLoginByGoogle):",
            ...
            if (
              ...
              console.log(
                "✅ User already set password or not Google login, proceeding to home"
              );
            }
          } catch (checkErr) {
