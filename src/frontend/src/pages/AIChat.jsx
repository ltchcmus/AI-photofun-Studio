    ...
    <div className="space-y-6">
      ...
      <header className="flex items-center justify-between gap-4 border border-gray-200 rounded-2xl px-4 py-3 bg-white shadow-sm">
        <button
          ...
          className="flex items-center gap-2 text-gray-600 hover:text-gray-900 text-sm font-semibold cursor-pointer"
        >
                    ...
                    {msg.role === "bot" && (
                      <div className="flex flex-wrap gap-2 mt-2">
                        <button
                          ...
                          className="flex items-center gap-1 text-xs bg-gray-100 hover:bg-gray-200 px-3 py-1.5 rounded-lg cursor-pointer"
                        >
                        ...
                        <button
                          ...
                          className="flex items-center gap-1 text-xs bg-purple-100 hover:bg-purple-200 text-purple-700 px-3 py-1.5 rounded-lg cursor-pointer"
                        >
                          <RotateCcw className="w-3 h-3" /> Edit
                        </button>
                        <button
                          onClick={() => handleShareToFeed(msg.imageUrl)}
                          className="flex items-center gap-1 text-xs bg-green-100 hover:bg-green-200 text-green-700 px-3 py-1.5 rounded-lg cursor-pointer"
                        >
                          <Share2 className="w-3 h-3" /> Post Feed
                        </button>
                        <button
                          onClick={() => handleShareToGroup(msg.imageUrl)}
                          className="flex items-center gap-1 text-xs bg-blue-100 hover:bg-blue-200 text-blue-700 px-3 py-1.5 rounded-lg cursor-pointer"
                        >
        ...
        <div className="p-4 border-t border-gray-200 bg-white">
          ...
          <div className="flex gap-2">
            <button
              ...
              disabled={isUploading}
              className="w-12 h-12 rounded-xl bg-gray-100 hover:bg-gray-200 flex items-center justify-center transition-colors disabled:opacity-50 cursor-pointer"
              title="Upload image"
            >
              {isUploading ? (
            ...
            <button
              ...
              className="w-12 h-12 rounded-xl bg-gradient-to-r from-purple-600 to-blue-600 text-white flex items-center justify-center hover:opacity-90 transition-opacity disabled:opacity-50 cursor-pointer"
            >
              {isLoading ? (
      ...
      {lightboxImage && (
        ...
        >
          <button
            className="absolute top-4 right-4 text-white text-4xl hover:opacity-70 cursor-pointer"
            onClick={() => setLightboxImage(null)}
          >
            ×
          </button>
