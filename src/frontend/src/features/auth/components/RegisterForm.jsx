...
const RegisterPage = () => {
  ...
  const loginWithFacebook = () => {
    // Translated alert
    alert('Facebook sign-up function (Demo)');
  };
        ...
        <div className="bg-white rounded-3xl px-10 py-12 shadow-2xl">
          ...
          <div className="mb-6">
            ...
            <button 
              ...
              className="w-full py-3.5 bg-black text-white rounded-xl text-base font-semibold cursor-pointer transition-all duration-300 hover:bg-gray-800 hover:-translate-y-0.5 hover:shadow-lg active:translate-y-0"
            >
              {/* Translated */}
              Sign Up
            </button>
          ...
          <div className="text-center">
            ...
            <Link to ="/login" className="text-black bg-transparent border-none cursor-pointer font-semibold transition-opacity duration-300 hover:opacity-70 text-sm">Log in now</Link>
          </div>
