...
public class AuthController {
  ...
  @PostMapping("/login")
  public HttpResponse<LoginResponse>
  ...
  public HttpResponse<IntrospectIgnoreRefreshResponse>
  introspectAccessToken(@PathVariable("id") String token)
  ...
  public HttpResponse<IntrospectRefreshResponse>
  introspectRefreshToken(@PathVariable("id") String token)
      throws ParseException, JOSEException {
  ...
  HttpResponse<String> refreshToken(@PathVariable("token") String token,
                                    HttpServletResponse httpServletResponse)
      throws ParseException, JOSEException {
  ...
  HttpResponse<RefreshTokenResponse> refreshTokenFromCookie(
    ...
    return HttpResponse.<RefreshTokenResponse>builder()
        ...
        .result(RefreshTokenResponse.builder().accessToken(accessToken).build())
        .build();
  }
}
