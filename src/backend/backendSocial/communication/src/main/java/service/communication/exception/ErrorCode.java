...
public enum ErrorCode {
    ...
    RECEIVER_ID_EMPTY(2002, "Receiver ID cannot be empty", HttpStatus.BAD_REQUEST),
    ...
    FAILED_TO_REQUEST_JOIN_GROUP(2005, "Failed to request join group", HttpStatus.INTERNAL_SERVER_ERROR),
    FAILED_TO_DELETE_REQUEST_JOIN_GROUP(2006, "Failed to delete request join group", HttpStatus.INTERNAL_SERVER_ERROR),
    FAILED_TO_ADD_GROUP(2007, "Failed to add group", HttpStatus.INTERNAL_SERVER_ERROR)
    ;
