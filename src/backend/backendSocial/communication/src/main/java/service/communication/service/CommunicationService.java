...
public class CommunicationService{
    ...
    public PageResponse<GetMessageCoupleResponse> getPageMessage(String receiverId, int page, int size) {
        ...
        Page<Communication> pageCommunication = communicationRepository.findById(mongoId, pageable);
        ...
        return PageResponse.<GetMessageCoupleResponse>builder()
                ...
                .items(pageCommunication.getContent().stream().map((communication)->{
                    GetMessageCoupleResponse response = communicationMapper.toGetMessageCoupleResponse(communication);
                    response.setTimestamp(utils.formatTimestamp(communication.getTimestamp()));
                    return response;
                }).toList())
                .build();
