    ...
    <div>
      <div className="api-section">
        ...
        <div className="btn-group">
          <button
            ...
            onClick={() =>
              apiCall("GET", "/api/v1/posts/get-all?page=1&size=20")
            }
            disabled={loading}
          >
          ...
          <button
            className="btn btn-primary"
            onClick={() =>
              apiCall("GET", "/api/v1/posts/my-posts?page=1&size=20")
            }
            disabled={loading}
          >
            Get My Posts (API #30)
      ...
      <div className="api-section">
        ...
        <div className="form-row">
          ...
          <button
            className="btn btn-primary"
            onClick={() => apiCall("GET", `/api/v1/posts/view/${postId}`)}
            disabled={loading}
          >
            View Post
          </button>
      ...
      <div className="api-section">
        ...
        <div className="form-row">
          ...
          <button
            ...
            onClick={() => {
              window.open(
                `${config.apiGateway}/api/v1/posts/download/${postId}`,
                "_blank"
              );
            }}
            disabled={loading}
